...
const Navbar = () => {
  ...
  const [cartModalOpen, setCartModalOpen] = useState(false); // ✅ Add cart modal state
  ...
  // ✅ Add function to open cart modal
  const openCartModal = () => {
    setCartModalOpen(true);
  };

  // ✅ Add function to close cart modal
        ...
        <header className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              {/* Cart - ✅ Changed from Link to button with click handler */}
              <button 
